...
from src.confluence_mcp.functions.page import (
    list_pages_impl, get_page_impl, create_page_impl, update_page_impl, delete_page_impl
)
...
async def test_list_pages_fetch_all(mock_get_client):
    ...
    # Verify API call
    mock_client.fetch_all_pages.assert_called_once_with("content", 
        {"limit": 25, "space-id": "SPACE-123"}
    )
