...
from src.confluence_mcp.functions.space import list_spaces_impl as list_spaces, get_space_impl as get_space
...
class TestSpaceFunctions(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_list_spaces_with_filters(self, mock_get_client):
        ...
        mock_client.get.assert_called_once_with(
            "spaces", 
            {"limit": 10, "keys": "TEST", "status": "current", "type": "global"}
        )
